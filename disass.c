...
//  { "name"   , enum          , size, mask        , static_mask , n,   op_type    , cond   , {{field ,shr,shl,  +, size, sign, index, TYPE_REG}, ...}
    ...
    { "loop"   , N850_LOOP    ,    4, 0x6FFFFFF  , 0x6E00001  , 2,   OP_TYPE_LOOP, COND_NZ, {{0x0000f800,  11,  0,  0, 5, UNSIGNED, 0, TYPE_REG}, {0x0000fffe,  0,  0,  0, 16, UNSIGNED, 1, TYPE_LOOP}, {0}, {0}, {0}}},
    ...
    { "cmpf.s"   , N850_CMPFSF     ,    4, 0xFFFF7C2E , 0x07E00420  , 4,   OP_TYPE_CMP, COND_NV, {{0x7800,  11,  0,  0, 4, UNSIGNED, 0, TYPE_COND}, {0xf8000000,  27,  0,  0, 5, UNSIGNED, 1, TYPE_REG}, {0x001f0000,  16,  0,  0, 5, UNSIGNED, 2, TYPE_REG}, {0x0000000E,  1,  0,  0, 3, UNSIGNED, 3, TYPE_IMM}, {0}}},
    ...
    */
    ...
    { "bins"   , N850_BINS2    ,    4, 0xFFFFF8BE  , 0x07e000B0  , 4,   OP_TYPE_MOV, COND_NV, {{0x001f0000,  16,  0,  0, 5, UNSIGNED, 0, TYPE_REG}, {0xf8000000,  27,  0,  0, 5, UNSIGNED, 3, TYPE_REG}, {0x0000F000,  12,  0,  0x10, 5, UNSIGNED, 2, TYPE_BINS2}, {0x00000800,  8,  0,  0, 1, UNSIGNED, 1, TYPE_IMM}, {0x0000000E,  1,  0,  0, 3, UNSIGNED, 1, TYPE_IMM}}},
    ...
    /*UNTESTED*/{ "dispose"   , N850_DISPOSE     ,    4, 0x67fffe0  , 0x6400000  , 2,   OP_TYPE_MOV, COND_NV, {{0x003e0000,  17,  2,  0, 5, UNSIGNED, 0, TYPE_IMM}, {0x0001ffe0,  5,  0,  0, 12, UNSIGNED, 1, TYPE_LIST}, {0}, {0}, {0}}},
    /*UNTESTED*/{ "dispose"   , N850_DISPOSER     ,    4, 0x67fffff  , 0x6400000  , 3,   OP_TYPE_MOV, COND_NV, {{0x003e0000,  17,  2,  0, 5, UNSIGNED, 0, TYPE_IMM}, {0x0001ffe0,  5,  0,  0, 12, UNSIGNED, 1, TYPE_LIST}, {0x0000001f,  0,  0,  0, 5, UNSIGNED, 2, TYPE_REG}, {0}, {0}}},
    ...
    /*UNTESTED*/{ "sasf"   , N850_SASF     ,    4, 0xffef0200  , 0x07e00200  , 2,   OP_TYPE_SHL, COND_NV, {{0xf8000000,  27,  0,  0, 5, UNSIGNED, 1, TYPE_REG}, {0x000f0000,  16,  0,  0, 4, UNSIGNED, 0, TYPE_CR}, {0}, {0}, {0}}},
    ...
    { "stsr"   , N850_STSRI     ,    4, 0xfffff840  , 0x07e00040  , 2,   OP_TYPE_OR, COND_NV, {{0xF8000000,  27,  0,  0, 5, UNSIGNED, 1, TYPE_REG}, {0x001f0000,  16,  0,  0, 5, UNSIGNED, 0, TYPE_SYSREG}, {0x0000f800,  11,  0,  0, 5, UNSIGNED, 2, TYPE_IMM}, {0}, {0}}},
